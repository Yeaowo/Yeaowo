...
### 💡 About Me
- 🗺️ **GIS & WebGL 探索者:** 沉迷于在 Web 端构建地图引擎，让数据在浏览器里立体起来。
- 🤖 **AI 赋能开发者:** 熟练掌握“面向 AI 编程”，遇事不决先问 AI，主打一个高效防脱发。
- 🎮 **游戏与工具制造机:** 喜欢为热爱的游戏（比如星露谷）写硬核辅助工具。
- 🌱 **目前状态:** 寻找并复刻任何“有趣”的技术，主打一个瞎折腾与造轮子。
...
<div align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=js,ts,html,css,nodejs,mysql,python,git,github,vscode&theme=dark" alt="Tech Stack" />
  </a>
</div>
<br>

### 🚀 Featured Projects
* **[StardewWeb](https://github.com/Yeaowo/StardewWeb)** - 星露谷物语工具箱，提供实用的游戏辅助功能。
* **[OfflineMap](https://github.com/Yeaowo/OfflineMap)** - 基于 MySQL + Node.js + Leaflet 的多平台离线地图展示方案。
* **[WebGlobe](https://github.com/Yeaowo/WebGlobe)** - 基于 HTML5 原生 WebGL 实现的轻量级 Google Earth 三维地图引擎。
